...
def parse_with_xpath(url_list, bloom):
    ...
    # 获取城市url
    url_city_buildings = get_city_url(url_list, empories_url)
...
def thread_start(url):
    ...
    if city_list:
        ...
        return None
    city_urls = ['/city/100560/hamburg-germany', '/city/100561/munich-germany',
                '/city/100562/cologne-germany', '/city/100563/frankfurt-am-main-germany',
                '/city/100566/stuttgart-germany', '/city/100567/duesseldorf-germany',
                 '/city/100573/dresden-germany', '/city/100570/hanover-germany',
                 '/city/100571/nuremberg-germany', '/city/100569/duisburg-germany']
    # # 线程组
    city_urls = [city_urls[i:i + 1] for i in range(0, len(city_urls), 1)]
    print(city_urls, len(city_urls))
    threads = []
    for urls_list in city_urls:
        # print(len(urls))
...
def emporis_start(urls_list, bloom):
    items = parse_with_xpath(urls_list, bloom)
    num = write_db(items)
...
if __name__ == '__main__':
    country_url1 = 'https://www.emporis.com/country/100035/germany'
    # country_url1 = 'https://www.emporis.com/country/100146/saudi-arabia'
    thread_start(country_url1)
